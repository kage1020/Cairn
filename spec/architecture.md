# 3. Architecture (three-layer IR + universal pivot)
...
- It is the output target of the forward direction and the input destination of the reverse direction
  ([ecosystem-interop.md](ecosystem-interop.md)).
...
When redstone is described logically ([redstone.md](redstone.md)), three IR layers with distinct roles
