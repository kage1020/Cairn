...
pub enum RoutePathError {
    ...
    TargetUnreachable,
    /// The search rectangle exceeds the router's area cap; the site is too
...
/// bounded by the router's area cap alone.
...
/// path length exceeding the area-cap-derived bound, or a
