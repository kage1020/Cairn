...
const napi_type_tag LANGUAGE_TYPE_TAG = {0x1C4CD379FD3C4C3C, 0x8E8394F4C7B2B4D8};

Napi::Object Init(Napi::Env env, Napi::Object exports) {
  exports["name"] = Napi::String::New(env, "cairn");
  auto language_ptr = tree_sitter_cairn();
  if (language_ptr == nullptr) {
    Napi::Error::New(env, "tree_sitter_cairn() returned null; ABI mismatch?")
