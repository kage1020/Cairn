...
See [../../docs/superpowers/specs/2026-07-23-tree-sitter-cairn-design.md](../../docs/superpowers/specs/2026-07-23-tree-sitter-cairn-design.md) for the design and [../../docs/superpowers/plans/2026-07-23-tree-sitter-cairn.md](../../docs/superpowers/plans/2026-07-23-tree-sitter-cairn.md) for the implementation plan.
...
Grammar edits without a matching `pnpm run generate` will fail the `generate-check` job in `.github/workflows/tree-sitter.yml`.
