...
specification in [`spec/`](spec/README.md) and not yet a reference implementation. The most valuable
contributions right now are design critique, concrete proposals, and worked examples.
...
- Reference design principles as `P1`–`P5` (see [spec/principles.md](spec/principles.md)).
...
4. Notes the impact on the evaluation metrics (see [spec/evaluation.md](spec/evaluation.md)).
