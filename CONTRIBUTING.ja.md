...
[仕様書](https://kage1020.github.io/Cairn/ja/spec/) (ソースは
...
- 定義された用語 (`intent_state` / `resolved_state`, `mat_slot`, canonical token など) を一貫して使って
  ...
  [用語集](https://kage1020.github.io/Cairn/ja/spec/glossary/) を参照。
- 設計原則は `P1`–`P5` として参照してください
  ([設計原則](https://kage1020.github.io/Cairn/ja/spec/principles/))。
...
4. 評価メトリクスへの影響
   ([評価フレームワーク](https://kage1020.github.io/Cairn/ja/spec/evaluation/))。
