...
- ドキュメント: クレート別 README、
  [開発者ガイド](https://kage1020.github.io/Cairn/development/)、
  [チュートリアル](https://kage1020.github.io/Cairn/tutorial/)、
  [実用例](https://kage1020.github.io/Cairn/examples/)、横断
  [用語集](https://kage1020.github.io/Cairn/spec/glossary/)。
...
- [`website/`](website/README.md) のドキュメントサイト (Astro + Starlight、英語 + 日本語)。
  仕様書、チュートリアル、開発者ガイド、サンプル目次は
  [`website/src/content/docs/`](website/src/content/docs/) で直接編集します。`cairn-wasm`
  バインディングを将来取り込むためのプレイグラウンドプレースホルダ、`main` への push で公開する
  GitHub Pages ワークフロー付き。
